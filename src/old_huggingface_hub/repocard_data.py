...
from old_huggingface_hub.utils import logging, yaml_dump
...
class ModelCardData(CardData):
    ...
    Args:
        ...
        eval_results (`Union[List[EvalResult], EvalResult]`, *optional*):
            List of `old_huggingface_hub.EvalResult` that define evaluation results of the model. If provided,
    ...
    Example:
        ```python
        >>> from old_huggingface_hub import ModelCardData
...
def model_index_to_eval_results(model_index: List[Dict[str, Any]]) -> Tuple[str, List[EvalResult]]:
    """Takes in a model index and returns the model name and a list of `old_huggingface_hub.EvalResult` objects.
    ...
    Returns:
        ...
        eval_results (`List[EvalResult]`):
            A list of `old_huggingface_hub.EvalResult` objects containing the metrics
            reported in the provided model_index.

    Example:
        ```python
        >>> from old_huggingface_hub.repocard_data import model_index_to_eval_results
...
def eval_results_to_model_index(model_name: str, eval_results: List[EvalResult]) -> List[Dict[str, Any]]:
    """Takes in given model name and list of `old_huggingface_hub.EvalResult` and returns a
    ...
    Args:
        ...
        eval_results (`List[EvalResult]`):
            List of `old_huggingface_hub.EvalResult` objects containing the metrics to be
    ...
    Example:
        ```python
        >>> from old_huggingface_hub.repocard_data import eval_results_to_model_index, EvalResult
