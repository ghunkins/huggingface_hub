...
class CommitScheduler:
    ...
    triggered. Checkout the [upload guide](https://huggingface.co/docs/old_huggingface_hub/guides/upload#scheduled-uploads)
    ...
    def push_to_hub(self) -> Optional[CommitInfo]:
        ...
        out our [integration guide](https://huggingface.co/docs/old_huggingface_hub/main/en/guides/upload#scheduled-uploads).
        """
