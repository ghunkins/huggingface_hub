...
class HfFolder:
    ...
    # @_deprecate_method(version="1.0", message="Use `old_huggingface_hub.login` instead.")
    @classmethod
    ...
    # TODO: deprecate when adapted in transformers/datasets/gradio
    # @_deprecate_method(version="1.0", message="Use `old_huggingface_hub.get_token` instead.")
    @classmethod
    def get_token(cls) -> Optional[str]:
        """
        Get token or None if not existent.

        This method is deprecated in favor of [`old_huggingface_hub.get_token`] but is kept for backward compatibility.
        Its behavior is the same as [`old_huggingface_hub.get_token`].
    ...
    # TODO: deprecate when adapted in transformers/datasets/gradio
    # @_deprecate_method(version="1.0", message="Use `old_huggingface_hub.logout` instead.")
    @classmethod
