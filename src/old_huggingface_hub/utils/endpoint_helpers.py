...
class DatasetFilter:
    ...
    <Tip warning={true}>
        ...
        The `DatasetFilter` class is deprecated and will be removed in old_huggingface_hub>=0.24. Please pass the filter parameters as keyword arguments directly to [`list_datasets`].
    ...
    ```py
    >>> from old_huggingface_hub import DatasetFilter
    ...
    def __post_init__(self):
        warnings.warn(
            "'DatasetFilter' is deprecated and will be removed in old_huggingface_hub>=0.24. Please pass the filter parameters as keyword arguments directly to the `list_datasets` method.",
...
class ModelFilter:
    ...
    <Tip warning={true}>
        ...
        The `ModelFilter` class is deprecated and will be removed in old_huggingface_hub>=0.24. Please pass the filter parameters as keyword arguments directly to [`list_models`].
    ...
    ```python
    >>> from old_huggingface_hub import ModelFilter
    ...
    def __post_init__(self):
        warnings.warn(
            "'ModelFilter' is deprecated and will be removed in old_huggingface_hub>=0.24. Please pass the filter parameters as keyword arguments directly to the `list_models` method.",
            FutureWarning,
        )
