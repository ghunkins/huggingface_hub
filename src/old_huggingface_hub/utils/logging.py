...
def get_logger(name: Optional[str] = None) -> logging.Logger:
    ...
    ```python
    >>> from old_huggingface_hub import get_logger
...
def get_verbosity() -> int:
    ...
    Returns:
        Logging level, e.g., `old_huggingface_hub.logging.DEBUG` and
        `old_huggingface_hub.logging.INFO`.

    <Tip>

    HuggingFace Hub has following logging levels:

    - `old_huggingface_hub.logging.CRITICAL`, `old_huggingface_hub.logging.FATAL`
    - `old_huggingface_hub.logging.ERROR`
    - `old_huggingface_hub.logging.WARNING`, `old_huggingface_hub.logging.WARN`
    - `old_huggingface_hub.logging.INFO`
    - `old_huggingface_hub.logging.DEBUG`
