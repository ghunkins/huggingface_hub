...
from .constants import (
    ...
    old_huggingface_hub_CACHE,  # noqa: F401 # for backward compatibility
    REPO_ID_SEPARATOR,
    REPO_TYPES,
        ...
        with SoftTemporaryDirectory(dir=cache_dir) as tmpdir:
            ...
            try:
                ...
                if not HF_HUB_DISABLE_SYMLINKS_WARNING:
                    message = (
                        "`old_huggingface_hub` cache-system uses symlinks by default to"
                        ...
                        " more details, see"
                        " https://huggingface.co/docs/old_huggingface_hub/how-to-cache#limitations."
                    )
                    if os.name == "nt":
                        message += (
...
def hf_hub_url(
    ...
    *,
    ...
    ```python
    >>> from old_huggingface_hub import hf_hub_url
...
def http_get(
    ...
    *,
    ...
    consistency_error_message = (
        ...
        "on https://github.com/huggingface/old_huggingface_hub."
    )
    ...
    if progress is None:
        progress = tqdm(
            ...
            # see https://github.com/huggingface/old_huggingface_hub/pull/2000
            name="old_huggingface_hub.http_get",
        )
...
def _normalize_etag(etag: Optional[str]) -> Optional[str]:
    ...
    more context, see `TestNormalizeEtag` tests and https://github.com/huggingface/old_huggingface_hub/pull/1428.
...
def _create_symlink(src: str, dst: str, new_blob: bool = False) -> None:
    ...
    - Relative paths seems to be better handled on Windows. Issue was reported 3 times in less than a week when
      changing from relative to absolute paths. See https://github.com/huggingface/old_huggingface_hub/issues/1398,
    ...
    In case symlinks are not supported, a warning message is displayed to the user once when loading `old_huggingface_hub`.
...
def _cache_commit_hash_for_specific_revision(storage_folder: str, revision: str, commit_hash: str) -> None:
    ...
    if revision != commit_hash:
        ...
        if not ref_path.exists() or commit_hash != ref_path.read_text():
            ...
            # See https://github.com/huggingface/old_huggingface_hub/issues/1216.
    ...
    if local_dir is not None:
        if local_dir_use_symlinks != "auto":
            warnings.warn(
                ...
                "as`local_dir`.\n"
                "For more details, check out https://huggingface.co/docs/old_huggingface_hub/main/en/guides/download#download-files-to-local-folder."
            )
...
def _chmod_and_move(src: Path, dst: Path) -> None:
    ...
    - About solution: https://github.com/huggingface/old_huggingface_hub/pull/1220#issuecomment-1326211591
    - Fix issue: https://github.com/huggingface/old_huggingface_hub/issues/1141
    - Fix issue: https://github.com/huggingface/old_huggingface_hub/issues/1215
    """
