...
def get_token() -> Optional[str]:
    ...
    Note: in most cases, you should use [`old_huggingface_hub.utils.build_hf_headers`] instead. This method is only useful
...
def _get_token_from_google_colab() -> Optional[str]:
    ...
    # => use a lock
    # See https://github.com/huggingface/old_huggingface_hub/issues/1952 for more details.
    with _GOOGLE_COLAB_SECRET_LOCK:
        ...
        try:
            ...
            warnings.warn(
                ...
                "(https://github.com/huggingface/old_huggingface_hub/issues/new)."
            )
            _GOOGLE_COLAB_SECRET = None
