...
NOTE:
    ...
    This dependency has to be installed with `pip install old_huggingface_hub[cli]`. Since
...
See discussions in https://github.com/huggingface/old_huggingface_hub/issues/1025.
"""
    ...
    def _inner(*args, **kwargs):
        if not _inquirer_py_available:
            raise ImportError(
                ...
                " the TUI.\nPlease run `pip install old_huggingface_hub[cli]` to install"
