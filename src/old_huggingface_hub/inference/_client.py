...
class InferenceClient:
    ...
    def text_generation(
        ...
        *,
        ...
        >>> client.text_generation("The old_huggingface_hub library is ", max_new_tokens=12)
        '100% open source and built to be easy to use.'

        # Case 2: iterate over the generated tokens. Useful for large generation.
        >>> for token in client.text_generation("The old_huggingface_hub library is ", max_new_tokens=12, stream=True):
        ...     print(token)
        100
        %
        open
        ...
        >>> client.text_generation("The old_huggingface_hub library is ", max_new_tokens=12, details=True)
        TextGenerationOutput(
        ...
        >>> for details in client.text_generation("The old_huggingface_hub library is ", max_new_tokens=12, details=True, stream=True):
        ...     print(details)
        ...
