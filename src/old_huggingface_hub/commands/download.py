...
from old_huggingface_hub.utils import disable_progress_bars, enable_progress_bars
    ...
    def register_subcommand(parser: _SubParsersAction):
        ...
        download_parser.add_argument(
            ...
            help=(
                ...
                " https://huggingface.co/docs/old_huggingface_hub/guides/download#download-files-to-local-folder for more"
                " details."
            ),
        )
        download_parser.add_argument(
