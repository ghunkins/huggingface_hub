...
from old_huggingface_hub.commands.env import EnvironmentCommand
from old_huggingface_hub.commands.lfs import LfsCommands
...
from old_huggingface_hub.commands.user import UserCommands
