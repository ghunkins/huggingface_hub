...
# See https://github.com/huggingface/old_huggingface_hub/issues/1503
...
def _upload_lfs_files(
    *,
    ...
    if HF_HUB_ENABLE_HF_TRANSFER:
        ...
        for action in hf_tqdm(filtered_actions, name="old_huggingface_hub.lfs_upload"):
...
def _prepare_commit_payload(
    ...
    For more information, see:
        - https://github.com/huggingface/old_huggingface_hub/issues/1085#issuecomment-1265208073
        - http://ndjson.org/
    """
