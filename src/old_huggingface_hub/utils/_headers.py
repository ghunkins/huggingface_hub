...
from old_huggingface_hub.errors import LocalTokenNotFoundError
...
def build_hf_headers(
    *,
    ...
    the installed packages (versions of python, old_huggingface_hub, torch, tensorflow,
    fastai and fastcore).
    ...
    if token is True:
        if cached_token is None:
            raise LocalTokenNotFoundError(
                ...
                " `huggingface-cli login` or `old_huggingface_hub.login`. See"
