...
from old_huggingface_hub._commit_scheduler import CommitScheduler
from old_huggingface_hub.commands import BaseHuggingfaceCLICommand
from old_huggingface_hub.constants import HF_HUB_ENABLE_HF_TRANSFER
from old_huggingface_hub.hf_api import HfApi
from old_huggingface_hub.utils import RevisionNotFoundError, disable_progress_bars, enable_progress_bars
    ...
    def _upload(self) -> str:
        ...
        if not HF_HUB_ENABLE_HF_TRANSFER:
            logger.info(
                ...
                " https://huggingface.co/docs/old_huggingface_hub/hf_transfer for more details."
            )
