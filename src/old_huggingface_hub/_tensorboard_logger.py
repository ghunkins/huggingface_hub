...
class HFSummaryWriter(SummaryWriter):
    ...
    Args:
        ...
        repo_allow_patterns (`List[str]` or `str`, *optional*):
            ...
            [upload guide](https://huggingface.co/docs/old_huggingface_hub/guides/upload#upload-a-folder) for more details.
    ...
    Examples:
    ```py
    >>> from old_huggingface_hub import HFSummaryWriter
