...
from old_huggingface_hub.hf_api import upload_file
...
from old_huggingface_hub.utils import get_session, is_jinja_available, yaml_dump
...
class RepoCard:
    ...
    def __init__(self, content: str, ignore_metadata_errors: bool = False):
        ...
        Example:
            ```python
            >>> from old_huggingface_hub.repocard import RepoCard
            >>> text = '''
            ... ---
            ... language: en
            ... license: mit
    ...
    def load(
        ...
        Args:
            ...
            token (`str`, *optional*):
                Authentication token, obtained with `old_huggingface_hub.HfApi.login` method. Will default to the stored token.
            ignore_metadata_errors (`str`):
                If True, errors while parsing the metadata section will be ignored. Some information might be lost during
                the process. Use it at your own risk.

        Returns:
            [`old_huggingface_hub.repocard.RepoCard`]: The RepoCard (or subclass) initialized from the repo's
    ...
    def validate(self, repo_type: Optional[str] = None):
        ...
        internally by [`old_huggingface_hub.repocard.RepoCard.push_to_hub`].
    ...
    def push_to_hub(
        ...
        Args:
            ...
            token (`str`, *optional*):
                Authentication token, obtained with `old_huggingface_hub.HfApi.login` method. Will default to
                the stored token.
            repo_type (`str`, *optional*, defaults to "model"):
    ...
    def from_template(
        ...
        **template_kwargs,
        ...
        Args:
            card_data (`old_huggingface_hub.CardData`):
                A old_huggingface_hub.CardData instance containing the metadata you want to include in the YAML
        ...
        Returns:
            [`old_huggingface_hub.repocard.RepoCard`]: A RepoCard instance with the specified card data and content from the
            template.
        """
...
class ModelCard(RepoCard):
    ...
    def from_template(  # type: ignore # violates Liskov property but easier to use
        ...
        **template_kwargs,
        ...
        https://github.com/huggingface/old_huggingface_hub/blob/main/src/old_huggingface_hub/templates/modelcard_template.md

        Templates are Jinja2 templates that can be customized by passing keyword arguments.

        Args:
            card_data (`old_huggingface_hub.ModelCardData`):
                A old_huggingface_hub.ModelCardData instance containing the metadata you want to include in the YAML
        ...
        Returns:
            [`old_huggingface_hub.ModelCard`]: A ModelCard instance with the specified card data and content from the
            template.

        Example:
            ```python
            >>> from old_huggingface_hub import ModelCard, ModelCardData, EvalResult
            ...
            >>> card = ModelCard.from_template(
            ...     card_data=card_data,
            ...     template_path='./src/old_huggingface_hub/templates/modelcard_template.md',
...
class DatasetCard(RepoCard):
    ...
    def from_template(  # type: ignore # violates Liskov property but easier to use
        ...
        **template_kwargs,
        ...
        https://github.com/huggingface/old_huggingface_hub/blob/main/src/old_huggingface_hub/templates/datasetcard_template.md

        Templates are Jinja2 templates that can be customized by passing keyword arguments.

        Args:
            card_data (`old_huggingface_hub.DatasetCardData`):
                A old_huggingface_hub.DatasetCardData instance containing the metadata you want to include in the YAML
        ...
        Returns:
            [`old_huggingface_hub.DatasetCard`]: A DatasetCard instance with the specified card data and content from the
            template.

        Example:
            ```python
            >>> from old_huggingface_hub import DatasetCard, DatasetCardData
            ...
            >>> card = DatasetCard.from_template(
            ...     card_data=card_data,
            ...     template_path='./src/old_huggingface_hub/templates/datasetcard_template.md',
            ...     custom_template_var='custom value',  # will be replaced in template if it exists
            ... )
...
def metadata_eval_result(
    *,
    ...
    Example:
        ```python
        >>> from old_huggingface_hub import metadata_eval_result
    ...
    *,
    ...
    Args:
        ...
        commit_message (`str`, *optional*):
            ...
            `f"Update metadata with old_huggingface_hub"`
        commit_description (`str` *optional*)
            The description of the generated commit
        revision (`str`, *optional*):
    ...
    Example:
        ...
        ```
    """
    commit_message = commit_message if commit_message is not None else "Update metadata with old_huggingface_hub"
