...
from old_huggingface_hub import ModelHubMixin, snapshot_download
...
def push_to_hub_keras(
    ...
    *,
    ...
    commit_message: str = "Push Keras model using old_huggingface_hub.",
    private: bool = False,
...
class KerasModelHubMixin(ModelHubMixin):
    ...
    >>> from old_huggingface_hub import KerasModelHubMixin
