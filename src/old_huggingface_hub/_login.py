...
def login(
    ...
    is logged in and the access token will be available across all `old_huggingface_hub`
...
def interpreter_login(new_session: bool = True, write_permission: bool = False) -> None:
    ...
    print("    To login, `old_huggingface_hub` requires a token generated from https://huggingface.co/settings/tokens .")
    if os.name == "nt":
...
def _is_git_credential_helper_configured() -> bool:
    ...
    # See https://github.com/huggingface/old_huggingface_hub/issues/1043#issuecomment-1247010710
    if is_google_colab():
...
def _set_store_as_git_credential_helper_globally() -> None:
    ...
    Related:
    - https://github.com/huggingface/old_huggingface_hub/issues/1043
    - https://github.com/huggingface/old_huggingface_hub/issues/1051
