...
old_huggingface_hub_CACHE = os.getenv("old_huggingface_hub_CACHE", default_cache_path)
HUGGINGFACE_ASSETS_CACHE = os.getenv("HUGGINGFACE_ASSETS_CACHE", default_assets_cache_path)

# New env variables
HF_HUB_CACHE = os.getenv("HF_HUB_CACHE", old_huggingface_hub_CACHE)
...
# See https://github.com/huggingface/old_huggingface_hub/issues/1232
...
if _staging_mode:
    ...
    old_huggingface_hub_CACHE = os.path.join(_staging_home, "hub")
