...
from old_huggingface_hub.constants import REPO_TYPES_URL_PREFIXES, REPOCARD_NAME
from old_huggingface_hub.repocard import metadata_load, metadata_save
    ...
    def output_progress(stopping_event: threading.Event):
        ...
        for line in tail_file(os.environ["GIT_LFS_PROGRESS"]):
            try:
                ...
                # Try/except to ease debugging. See https://github.com/huggingface/old_huggingface_hub/issues/1373.
            ...
            if pbar is None:
                ...
                pbars[(state, filename)] = {
                    "bar": tqdm(
                        ...
                        unit_scale=True,
                        unit_divisor=1024,
                        name="old_huggingface_hub.lfs_upload",
                    ),
...
class Repository:
    ...
    https://huggingface.co/docs/old_huggingface_hub/concepts/git_vs_http.
    ...
    def __init__(
        ...
        Args:
            ...
            token (`bool` or `str`, *optional*):
                ...
                or [`~old_huggingface_hub.login`]), token will be retrieved from the cache.
