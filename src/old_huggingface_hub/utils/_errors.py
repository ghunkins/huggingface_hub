...
class HfHubHTTPError(HTTPError):
    ...
    ```py
        import requests
        from old_huggingface_hub.utils import get_session, hf_raise_for_status, HfHubHTTPError
...
class RepositoryNotFoundError(HfHubHTTPError):
    ...
    (...)
    old_huggingface_hub.utils._errors.RepositoryNotFoundError: 401 Client Error. (Request ID: PvMw_VjBMjVdMz53WKIzP)
...
class GatedRepoError(RepositoryNotFoundError):
    ...
    (...)
    old_huggingface_hub.utils._errors.GatedRepoError: 403 Client Error. (Request ID: ViT1Bf7O_026LGSQuVqfa)
...
class DisabledRepoError(HfHubHTTPError):
    ...
    ```py
    >>> from old_huggingface_hub import dataset_info
    >>> dataset_info("laion/laion-art")
    (...)
    old_huggingface_hub.utils._errors.DisabledRepoError: 403 Client Error. (Request ID: Root=1-659fc3fa-3031673e0f92c71a2260dbe2;bc6f4dfb-b30a-4862-af0a-5cfe827610d8)
...
class RevisionNotFoundError(HfHubHTTPError):
    ...
    (...)
    old_huggingface_hub.utils._errors.RevisionNotFoundError: 404 Client Error. (Request ID: Mwhe_c3Kt650GcdKEFomX)
...
class EntryNotFoundError(HfHubHTTPError):
    ...
    (...)
    old_huggingface_hub.utils._errors.EntryNotFoundError: 404 Client Error. (Request ID: 53pNl6M0MxsnG5Sw8JA6x)
...
class LocalEntryNotFoundError(EntryNotFoundError, FileNotFoundError, ValueError):
    ...
    (...)
    old_huggingface_hub.utils._errors.LocalEntryNotFoundError: Cannot find the requested files in the disk cache and outgoing traffic has been disabled. To enable hf.co look-ups and downloads online, set 'local_files_only' to False.
    ```
    """
...
class BadRequestError(HfHubHTTPError, ValueError):
    ...
    old_huggingface_hub.utils._errors.BadRequestError: Bad request for check endpoint: {details} (Request ID: XXX)
    ```
    """
