...
path = /path/to/old_huggingface_hub/.env/bin/python args = -m debugpy --listen 5678
--wait-for-client
/path/to/old_huggingface_hub/src/old_huggingface_hub/commands/huggingface_cli.py
...
from old_huggingface_hub.lfs import LFS_MULTIPART_UPLOAD_COMMAND, SliceFileObj
