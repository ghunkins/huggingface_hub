...
This model has been pushed to the Hub using the [PytorchModelHubMixin](https://huggingface.co/docs/old_huggingface_hub/package_reference/mixins#old_huggingface_hub.PyTorchModelHubMixin) integration:
...
class ModelHubMixin:
    ...
    def push_to_hub(
        ...
        *,
        config: Optional[Union[dict, "DataclassInstance"]] = None,
        commit_message: str = "Push model using old_huggingface_hub.",
        private: bool = False,
