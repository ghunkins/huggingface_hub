...
class ModelInfo:
    ...
    Attributes:
        ...
        card_data (`ModelCardData`, *optional*):
            Model Card Metadata  as a [`old_huggingface_hub.repocard_data.ModelCardData`] object.
        siblings (`List[RepoSibling]`):
            List of [`old_huggingface_hub.hf_api.RepoSibling`] objects that constitute the model.
...
class DatasetInfo:
    ...
    Attributes:
        ...
        card_data (`DatasetCardData`, *optional*):
            Model Card Metadata  as a [`old_huggingface_hub.repocard_data.DatasetCardData`] object.
        siblings (`List[RepoSibling]`):
            List of [`old_huggingface_hub.hf_api.RepoSibling`] objects that constitute the dataset.
    """
...
class SpaceInfo:
    ...
    Attributes:
        ...
        siblings (`List[RepoSibling]`):
            List of [`old_huggingface_hub.hf_api.RepoSibling`] objects that constitute the Space.
        card_data (`SpaceCardData`, *optional*):
            Space Card Metadata  as a [`old_huggingface_hub.repocard_data.SpaceCardData`] object.
        runtime (`SpaceRuntime`, *optional*):
            Space runtime information as a [`old_huggingface_hub.hf_api.SpaceRuntime`] object.
        sdk (`str`, *optional*):
...
class HfApi:
    def __init__(
        ...
        directly at the root of `old_huggingface_hub`.

        Args:
            token (Union[bool, str, None], optional):
                A valid user access token (string). Defaults to the locally saved
                token, which is the recommended method for authentication (see
                https://huggingface.co/docs/old_huggingface_hub/quick-start#authentication).
        ...
        *,
        ...
        Args:
            ...
            sort (`Literal["last_modified"]` or `str`, *optional*):
                ...
                are the properties of the [`old_huggingface_hub.hf_api.ModelInfo`] class.
        ...
        Returns:
            `Iterable[ModelInfo]`: an iterable of [`old_huggingface_hub.hf_api.ModelInfo`] objects.
        ...
        *,
        ...
        Args:
            ...
            sort (`Literal["last_modified"]` or `str`, *optional*):
                ...
                values are the properties of the [`old_huggingface_hub.hf_api.DatasetInfo`] class.
            direction (`Literal[-1]` or `int`, *optional*):
                Direction in which to sort. The value `-1` sorts by descending
                order while all other values sort by ascending order.
            limit (`int`, *optional*):
        ...
        Returns:
            `Iterable[DatasetInfo]`: an iterable of [`old_huggingface_hub.hf_api.DatasetInfo`] objects.
        ...
        *,
        ...
        Args:
            ...
            sort (`Literal["last_modified"]` or `str`, *optional*):
                ...
                values are the properties of the [`old_huggingface_hub.hf_api.SpaceInfo`]` class.
            direction (`Literal[-1]` or `int`, *optional*):
                Direction in which to sort. The value `-1` sorts by descending
                order while all other values sort by ascending order.
            limit (`int`, *optional*):
        ...
        Returns:
            `Iterable[SpaceInfo]`: an iterable of [`old_huggingface_hub.hf_api.SpaceInfo`] objects.
        """
    ...
    def like(
        ...
        *,
        ...
        Example:
        ```python
        >>> from old_huggingface_hub import like, list_liked_repos, unlike
        >>> like("gpt2")
    ...
    def list_liked_repos(
        ...
        *,
        ...
        Example:
        ```python
        >>> from old_huggingface_hub import list_liked_repos
    ...
    def model_info(
        ...
        *,
        ...
        Returns:
            [`old_huggingface_hub.hf_api.ModelInfo`]: The model repository information.
    ...
    def repo_info(
        ...
        *,
        ...
        Returns:
            ...
            [`old_huggingface_hub.hf_api.DatasetInfo`], [`old_huggingface_hub.hf_api.ModelInfo`]
            or [`old_huggingface_hub.hf_api.SpaceInfo`] object.
    ...
    def repo_exists(
        ...
        *,
        ...
        Examples:
            ```py
            >>> from old_huggingface_hub import repo_exists
    ...
    def revision_exists(
        ...
        *,
        ...
        Examples:
            ```py
            >>> from old_huggingface_hub import revision_exists
    ...
    def file_exists(
        ...
        *,
        ...
        Examples:
            ```py
            >>> from old_huggingface_hub import file_exists
        ...
        *,
        ...
        Args:
            ...
            expand (`bool`, *optional*, defaults to `False`):
                ...
                As pagination is implemented in `old_huggingface_hub`, this is transparent for you except for the time it
        ...
        Examples:
            ...
            ```py
            >>> from old_huggingface_hub import list_repo_tree
    ...
    def get_paths_info(
        ...
        *,
        ...
        Example:
        ```py
        >>> from old_huggingface_hub import get_paths_info
    ...
    def super_squash_history(
        ...
        *,
        ...
        headers = self._build_hf_headers(token=token)
        commit_message = commit_message or f"Super-squash branch '{branch}' using old_huggingface_hub"
    ...
    def create_repo(
        ...
        *,
        ...
        if getattr(self, "_lfsmultipartthresh", None):
            ...
            # See https://github.com/huggingface/old_huggingface_hub/pull/733/files#r820604472
    ...
    def create_commit(
        ...
        *,
        ...
        headers = {
            # See https://github.com/huggingface/old_huggingface_hub/issues/1085#issuecomment-1265208073
    ...
    def create_commits_on_pr(
        ...
        *,
        ...
        Example:
        ```python
        >>> from old_huggingface_hub import HfApi, plan_multi_commits
    ...
    def upload_file(
        ...
        *,
        ...
        commit_message = (
            commit_message if commit_message is not None else f"Upload {path_in_repo} with old_huggingface_hub"
        )
        ...
        *,
        ...
        Args:
            ...
            commit_message (`str`, *optional*):
                ...
                `f"Upload {path_in_repo} with old_huggingface_hub"`
            commit_description (`str` *optional*):
                The description of the generated commit
            create_pr (`boolean`, *optional*):
        ...
        commit_message = commit_message or "Upload folder using old_huggingface_hub"
        if multi_commits:
    ...
    def delete_file(
        ...
        *,
        ...
        Args:
            ...
            commit_message (`str`, *optional*):
                The summary / title / first line of the generated commit. Defaults to
                `f"Delete {path_in_repo} with old_huggingface_hub"`.
            commit_description (`str` *optional*)
                The description of the generated commit
            create_pr (`boolean`, *optional*):
                Whether or not to create a Pull Request with that commit. Defaults to `False`.
        ...
        """
        commit_message = (
            commit_message if commit_message is not None else f"Delete {path_in_repo} with old_huggingface_hub"
        )
    ...
    def delete_folder(
        ...
        *,
        ...
        Args:
            ...
            commit_message (`str`, *optional*):
                The summary / title / first line of the generated commit. Defaults to
                `f"Delete folder {path_in_repo} with old_huggingface_hub"`.
            commit_description (`str` *optional*)
                The description of the generated commit.
            create_pr (`boolean`, *optional*):
                Whether or not to create a Pull Request with that commit. Defaults to `False`.
        ...
        return self.create_commit(
            ...
            revision=revision,
            commit_message=(
                commit_message if commit_message is not None else f"Delete folder {path_in_repo} with old_huggingface_hub"
            ),
            commit_description=commit_description,
            create_pr=create_pr,
            parent_commit=parent_commit,
    ...
    def parse_safetensors_file_metadata(
        ...
        *,
        ...
        # See https://github.com/huggingface/old_huggingface_hub/pull/1855#discussion_r1404286419.
        ...
        *,
        ...
        Args:
            ...
            description (`str`, *optional*):
                ...
                Defaults to `"Discussion opened with the old_huggingface_hub Python library"`
        ...
        description = (
            ...
            if description
                ...
                " [old_huggingface_hub Python"
                " library](https://huggingface.co/docs/old_huggingface_hub)"
            )
        )
    ...
    def update_collection_metadata(
        ...
        *,
        ...
        ```py
        >>> from old_huggingface_hub import update_collection_metadata
    ...
    def add_collection_item(
        ...
        *,
        ...
        ```py
        >>> from old_huggingface_hub import add_collection_item
    ...
    def delete_collection_item(
        ...
        *,
        ...
        ```py
        >>> from old_huggingface_hub import get_collection, delete_collection_item
    ...
    def list_pending_access_requests(
        ...
        Example:
        ```py
        >>> from old_huggingface_hub import list_pending_access_requests, accept_access_request
    ...
    def list_accepted_access_requests(
        ...
        Example:
        ```py
        >>> from old_huggingface_hub import list_accepted_access_requests
    ...
    def list_rejected_access_requests(
        ...
        Example:
        ```py
        >>> from old_huggingface_hub import list_rejected_access_requests
